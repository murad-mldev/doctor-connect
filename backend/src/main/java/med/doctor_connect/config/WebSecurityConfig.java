...
import med.doctor_connect.service.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200", "http://localhost:58340"));
    ...
    public SecurityFilterChain adminSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/admin/login", "/api/v1/admin/logout").permitAll()
